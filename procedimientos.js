...
(function() {
  ...
  var MOCK = [
    ...
    { tipo:'Prueba Diagnóstica', nombre:'Espirometría', modalidad:'Prueba funcional respiratoria', establecimiento:'Contralor (CESFAM)', prioridad:'Normal', diagnosticos:'J44.1 EPOC descompensado, J45 Asma bronquial, J96.0 Insuficiencia respiratoria aguda', criterios:'1. Clasificación diagnóstica\n2. Prioridad: Normal / Alta (sospecha Ca)\n3. Fundamentos clínicos + teléfono\n4. ¿Resolutividad? Sí\n5. Derivar a contralor: Sí\n6. Paciente debe suspender broncodilatadores 4h antes\n7. No fumar 4h antes del examen', notas:'Contraindicado en infarto reciente (<1 mes) o neumotórax activo' },
    { tipo:'Prueba Diagnóstica', nombre:'Fondo de Ojo (Presencial) – DM2', modalidad:'Oftalmología', establecimiento:'UAPO Cerro Navia', prioridad:'Normal (GES)', diagnosticos:'E11 Diabetes Mellitus No insulinodependiente, E11.7 DM2 con múltiples complicaciones', criterios:'1. Clasificación diagnóstica → marcar GES\n2. Procedimiento: FONDO DE OJO (Presencial)\n3. Prioridad: Normal\n4. Extrasistema: NO\n5. Establecimiento: UAPO Cerro Navia\n6. Fundamentos clínicos + teléfono actualizado\n7. ¿Resolutividad? NO\n8. Derivar a contralor: SÍ\n9. Solo DM2 confirmada, frecuencia anual, sin diagnóstico de retinopatía ni cataratas no operada', notas:'Solo DM2 confirmada. No derivar si ya tiene retinopatía confirmada o cataratas no operada' },
    // IMAGENOLOGÍA
    { tipo:'Imagenología', nombre:'Ecotomografía Abdominal', modalidad:'Ecografía', establecimiento:'Contralor', prioridad:'Normal', diagnosticos:'K80 Colelitiasis, R10.1 Dolor abdominal en parte superior', criterios:'1. Clasificación diagnóstica\n2. Fundamentos clínicos + teléfono\n3. Prioridad: Normal\n4. ¿Resolutividad? Sí\n5. Derivar a contralor: Sí\n6. Incluye: hígado, vía biliar, vesícula, páncreas, riñones, bazo, retroperitoneo y grandes vasos', notas:'Código diagnóstico: R10.1 Dolor abdominal localizado en parte superior' },
    ...
    { tipo:'Imagenología', nombre:'Radiografía de Pelvis – Lactante/Niño <6 meses', modalidad:'Radiología simple', establecimiento:'Contralor', prioridad:'Normal', diagnosticos:'Q65.4 Subluxación congénita de la cadera, bilateral', criterios:'1. Clasificación diagnóstica\n2. Fundamentos clínicos\n3. Indicar: Pelvis, cadera o coxofemoral de RN, lactante o niño menor de 6 años', notas:'Usar en pesquisa de displasia del desarrollo de caderas' },
    // CIRUGÍA MENOR
