...
(async function () {
  ...
  const DB_BASE = [
    ...
    // ── Salud Mental Adultos – Derivación a DESAM/CSMC ────────────────────────
    // Protocolo SDGA-DSM-PRO-05 · Diciembre 2025 · Vigencia Diciembre 2030
    { cie10:"F323",  nombre:"Depresión – alto riesgo suicida", sinonimos:["depresion suicida","depresion riesgo suicidio","ideacion suicida depresion"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"Depresión con alto riesgo suicida", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, perfil lipídico, glicemia ayuno, Vitamina B12 (si disponible). Solicitud IC GES en paralelo con exámenes", notas:"GES depresión Nº34. Toda sospecha deriva a especialidad según mapa de derivación vigente y NTMA" },
    { cie10:"F325",  nombre:"Depresión con psicosis", sinonimos:["depresion psicotica","depresion con alucinaciones","depresion psicotica mayor"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"Depresión con psicosis", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, perfil lipídico, glicemia ayuno, Vitamina B12 (si disponible)", notas:"GES depresión Nº34" },
    { cie10:"F324",  nombre:"Depresión refractaria", sinonimos:["depresion refractaria","depresion resistente tratamiento","depresion 2 ensayos"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"Depresión refractaria: 2 o más ensayos terapéuticos con psicofármacos antidepresivos de diferentes familias (Anexo Nº6)", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, perfil lipídico, glicemia ayuno, Vitamina B12 (si disponible)", notas:"GES depresión Nº34" },
    { cie10:"F329",  nombre:"Depresión en mayores de 15 años – otros casos", sinonimos:["depresion adulto","depresion mayor","tristeza prolongada","animo deprimido"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P2", criterios:"Depresión en mayores de 15 años sin criterios de P0. Derivar según mapa de derivación vigente y NTMA GES depresión (Nº34)", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, perfil lipídico, glicemia ayuno, Vitamina B12 (si disponible)", notas:"GES depresión Nº34" },
    { cie10:"F200",  nombre:"Esquizofrenia – primer episodio psicótico", sinonimos:["esquizofrenia primer episodio","PEP","psicosis debut","primer episodio psicotico"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"GES", criterios:"Sospecha de esquizofrenia o Primer Episodio Psicótico (PEP). Derivación inmediata a especialidad ambulatoria para atención", examenes:"Derivación inmediata a especialidad ambulatoria", notas:"Priorización según NTMA GES Nº15" },
    { cie10:"F201",  nombre:"Esquizofrenia desorganizada", sinonimos:["esquizofrenia hebefrenica","esquizofrenia desorganizada","hebefrenia"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"GES", criterios:"Sospecha de esquizofrenia. Derivación inmediata a especialidad ambulatoria", examenes:"Derivación inmediata a especialidad ambulatoria", notas:"NTMA GES Nº15" },
    { cie10:"F209",  nombre:"Esquizofrenia con diagnóstico previo sin controles", sinonimos:["esquizofrenia descompensada","esquizofrenia sin control","esquizofrenia retomar controles"], especialidad:"Salud Mental Adultos", destino:"Urgencia / CSMC", prioridad:"GES", criterios:"Diagnóstico previo de esquizofrenia que requiere retomar controles. Agudización con alto riesgo suicida o agitación psicomotora: derivar a urgencia. De otro modo presentar en consultoría para retomar controles (Anexo 4)", examenes:"No aplica", notas:"NTMA GES Nº15" },
    { cie10:"F319",  nombre:"Trastorno afectivo bipolar", sinonimos:["bipolar","trastorno bipolar","TAB","mania depresion"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"GES", criterios:"Persona con sospecha de TAB (Anexo Nº5). Toda sospecha de TAB deriva a atención por especialidad ambulatoria. Detallar aspectos de riesgo en SIC", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, perfil lipídico, glicemia ayuno, Vitamina B12 (si disponible)", notas:"GES 75. Priorización de acuerdo con GES" },
    { cie10:"F431",  nombre:"Trastorno de estrés post traumático (TEPT)", sinonimos:["TEPT","estres postraumatico","PTSD","trauma psicologico"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"P0: riesgo alto de suicidio. P1: núcleo actual de síntomas activos y agudos. P2: los otros casos. Cumplir criterios CIE-10: reexperimentación del trauma mediante recuerdos intrusivos, aplanamiento emocional y/o hipervigilancia, incremento de reacción de alarma e insomnio", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, perfil hepático, glicemia ayuno, Vitamina B12 (si disponible), Vitamina D (si disponible)", notas:"P0: riesgo suicidio. P1: síntomas activos y agudos. P2: otros casos" },
    { cie10:"F429",  nombre:"Trastorno obsesivo compulsivo (TOC)", sinonimos:["TOC","obsesivo compulsivo","obsesiones compulsiones","pensamientos recurrentes egodistonicos"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"P0: riesgo alto de suicidio. P1: ideación suicida vinculada a obsesiones y/o compulsiones con criterios de refractariedad. P2: los otros casos. Cumplir criterios CIE-10: pensamientos obsesivos y/o actos compulsivos de manera recurrente, ambos egodistónicos", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, glicemia ayuno, Vitamina B12 (si disponible)", notas:"P0: riesgo alto suicidio. P1: ideación suicida + refractariedad. P2: otros" },
    { cie10:"F500",  nombre:"Anorexia nerviosa", sinonimos:["anorexia","anorexia nerviosa","restriccion alimentaria","bajo peso trastorno alimentario"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"P0: riesgo alto de suicidio. P1: ideación suicida. P2: los otros casos. Cumplir criterios CIE-10, sin criterios de hospitalización. Adjuntar evaluación nutricional y evaluación por matrona (Anexo Nº7)", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, glicemia ayuno, Vitamina B12 (si disponible), otros según diagnóstico diferencial", notas:"P0: riesgo suicidio. P1: ideación suicida. Sin criterios de hospitalización" },
    { cie10:"F502",  nombre:"Bulimia nerviosa", sinonimos:["bulimia","bulimia nerviosa","atracones purgas","trastorno alimentario bulimia"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"P0: riesgo alto de suicidio. P1: ideación suicida. P2: los otros casos. Cumplir criterios CIE-10, sin criterios de hospitalización. Adjuntar evaluación nutricional y evaluación por matrona (Anexo Nº7)", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, glicemia ayuno, Vitamina B12 (si disponible), otros según diagnóstico diferencial", notas:"P0: riesgo suicidio. P1: ideación suicida. Sin criterios de hospitalización" },
    { cie10:"F609",  nombre:"Trastorno de la conducta – adultos (refractario con comorbilidad)", sinonimos:["trastorno conducta adulto","conducta refractaria comorbilidad","F60 adulto"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"P0", criterios:"P0: riesgo alto de suicidio. P1: ideación suicida. P2: los otros casos. Sólo se derivarán casos que manifiesten comorbilidad con algún trastorno de salud mental que sea de derivación directa a especialidad. Casos refractarios deben presentarse siempre en consultoría", examenes:"TSH, T4L, Hemograma, Creatinina, BUN, electrolitos, perfil hepático, glicemia ayuno, Vitamina B12 (si disponible)", notas:"Casos refractarios: presentar en consultoría" },
    { cie10:"F840",  nombre:"Trastorno del Espectro Autista (TEA) adulto – con comorbilidad psiquiátrica", sinonimos:["autismo adulto","TEA adulto","espectro autista adulto","autismo comorbilidad"], especialidad:"Salud Mental Adultos", destino:"CSMC / DESAM", prioridad:"GES", criterios:"Persona con diagnóstico de TEA mayor de 18 años que debe ser presentada en consultoría de salud mental si se sospecha comorbilidad psiquiátrica. Sin comorbilidad psiquiátrica: manejo y seguimiento en APS. Derivaciones directas sin consultoría se consideran no pertinentes", examenes:"No aplica", notas:"Sin comorbilidad psiquiátrica: manejo en APS" },
    { cie10:"F709",  nombre:"Discapacidad intelectual – con comorbilidad psiquiátrica", sinonimos:["discapacidad intelectual comorbilidad","retraso mental psiquiatria","F70 psiquiatria"], especialidad:"Salud Mental Adultos", destino:"Consultoría CSMC", prioridad:"GES", criterios:"No pertinente para derivación a especialidad en salud mental y psiquiatría, salvo comorbilidad con patología psiquiátrica de base. Presentar en consultoría. En caso contrario el manejo es en APS", examenes:"N/A", notas:"Sin comorbilidad: manejo en APS" },
    { cie10:"F600",  nombre:"Trastorno de personalidad – con comorbilidad psiquiátrica", sinonimos:["trastorno personalidad psiquiatria","F60 comorbilidad","personalidad limite borderline psiquiatria"], especialidad:"Salud Mental Adultos", destino:"Consultoría CSMC", prioridad:"GES", criterios:"No pertinente para derivación directa a especialidad, salvo comorbilidad con patología psiquiátrica de base. Presentar en consultoría excepto si comorbilidad corresponde a patología GES. En caso contrario el manejo es en APS", examenes:"N/A", notas:"Sin comorbilidad GES: manejo en APS" },
    { cie10:"F009",  nombre:"Demencia – con comorbilidad psiquiátrica", sinonimos:["demencia psiquiatria","alzheimer comorbilidad psiquiatrica","deterioro cognitivo psiquiatria"], especialidad:"Salud Mental Adultos", destino:"Consultoría CSMC", prioridad:"GES", criterios:"No pertinente para derivación a especialidad, salvo comorbilidad con patología psiquiátrica de base. Presentar en consultoría excepto si comorbilidad es GES. En caso contrario el manejo es en APS", examenes:"N/A", notas:"Sin comorbilidad: manejo en APS" },
    { cie10:"G409",  nombre:"Epilepsia – con comorbilidad psiquiátrica", sinonimos:["epilepsia psiquiatria","epilepsia comorbilidad mental","convulsiones psiquiatria"], especialidad:"Salud Mental Adultos", destino:"Consultoría CSMC", prioridad:"GES", criterios:"No pertinente para derivación a especialidad ambulatoria en salud mental y psiquiatría, salvo concomitancia con patología psiquiátrica de base. Los casos con comorbilidad deben presentarse en consultoría. En caso contrario el manejo es en APS", examenes:"N/A", notas:"Sin comorbilidad psiquiátrica: manejo en APS" },
...
// ── Array global en memoria ─────────────────────────────────────────────────
  ...
  const PROC_BASE = [
    ...
    { id:"fondo_ojo", tipo:"Procedimiento", icono:"👁️", nombre:"Fondo de Ojo (Presencial)", modalidad:"Fondo de ojo", establecimiento:"UAPO Cerro Navia", prioridad:"Normal", diagnosticos:"E11 Diabetes Mellitus No insulinodependiente, E11.7 DM con múltiples complicaciones", criterios:"Solo DM2 confirmada. Frecuencia anual. Sin diagnóstico confirmado de retinopatía o cataratas no operada. Marcar GES. Extrasistema: No. Resolutividad: No. Derivar a contralor: Sí", notas:"Extrasistema: NO. GES obligatorio." },
